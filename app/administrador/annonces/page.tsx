  ...
  const annonces = [
    {
      ...
      content:
        "La rentrée scolaire est fixée au 2 septembre 2025...",
    ...
    <div className="flex h-screen bg-gray-100 text-gray-900">
      ...
      <main className="flex-1 p-4 md:p-6 w-full overflow-auto">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <button className="w-full md:w-auto flex items-center justify-center gap-2 bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800 text-sm">
        ...
        <div className="space-y-4">
          {annonces.map((a, i) => (
            <div
              key={i}
              className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm flex flex-col md:flex-row gap-4"
            >
              {/* ICON */}
              <div
